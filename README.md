...
2. **Set Up the Database**: Run the SQL scripts provided in the `SQL_Retail_Sales.sql` file to create and populate the database.
3. **Run the Queries**: Use the SQL queries provided in the `SQL_Retail_Sales.sql` file to perform your analysis.
